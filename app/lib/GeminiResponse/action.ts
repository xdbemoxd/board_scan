...
export async function queryGemini( query : queryG ) {
  ...
  try {
    ...
    promptParts.push({ 
      text: "Eres un experto en hardware y soporte técnico. Responde siempre en español. Sé claro, técnico y útil, se muy conciso, solo di fecha de creación, datos importantes y ¿Cuanto se puede potenciar?. Responde en texto plano sin markdown" 
    });
